"""Example: CrewAI multi-agent crew with SpecOps tracing (OpenAI).
...
Run:
    uv run examples/providers/openai/crewai_agent.py

Mock mode (no API key or crewai needed):
    SPECOPS_EXAMPLE_MODE=mock uv run examples/providers/openai/crewai_agent.py
"""
...
if __name__ == "__main__":
    print("=" * 60)
    print("SpecOps AI — CrewAI Multi-Agent Example (OpenAI)")
    print("=" * 60)
