"""Example: AutoGen multi-agent chat with SpecOps tracing (Grok/xAI).
...
Run:
    uv run examples/providers/grok/autogen_agent.py

Mock mode (no API key or autogen needed):
    SPECOPS_EXAMPLE_MODE=mock uv run examples/providers/grok/autogen_agent.py
"""
...
if __name__ == "__main__":
    print("=" * 60)
    print("SpecOps AI — AutoGen Multi-Agent Example (Grok/xAI)")
    print("=" * 60)
